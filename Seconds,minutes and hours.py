...
label = tk.Label(window, text="The result will appear here", font=("Arial", 20))
label.pack(pady=20)
...
def set_conversion(function, description):
    ...
    label.config(text=f"You selected: {description}")
...
def reset():
    ...
    label.config(text="The result will appear here")
    last_function = None
    last_description = ""
